...
<div class="w-full max-w-md">
    ...
    <div class="text-center mb-8">
        <a href="{{ url('/') }}">
            <div class="w-10 h-10 rounded-xl bg-green-500 flex items-center justify-center mx-auto">
        ...
        <h1 class="text-2xl font-bold text-gray-900 mt-3">Selamat Datang Kembali</h1>
        <p class="text-sm text-gray-500 mt-1">Masuk untuk melanjutkan booking Anda</p>
    </div>
    ...
    <div class="bg-white border border-gray-200 rounded-2xl p-8 shadow-sm">
        ...
        <div class="bg-blue-50 border border-blue-200 rounded-lg p-3 mb-5 text-xs text-blue-700 space-y-1">
            <p class="font-semibold mb-1">💡 Akun Demo:</p>
            <p>Admin: <span class="font-mono">admin@badmintonhall.com</span> / <span class="font-mono">password</span></p>
            <p>Customer: <span class="font-mono">customer@badmintonhall.com</span> / <span class="font-mono">password</span></p>
        </div>
    ...
    <p class="text-center text-sm text-gray-500 mt-6">
        Belum punya akun?
        <a href="{{ route('register') }}" class="text-green-600 font-semibold hover:underline">Daftar gratis</a>
    </p>
